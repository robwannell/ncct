class GraduatesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @graduate.save
        format.html { redirect_to graduates_path, notice: 'Graduate was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @graduate.update(graduate_params)
        format.html { redirect_to graduates_path, notice: 'Graduate was successfully updated.' }
  ...
  private
    ...
    def graduate_params
      params.require(:graduate).permit(:counter)
    end
end
