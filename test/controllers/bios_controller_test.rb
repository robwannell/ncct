...
class BiosControllerTest < ActionController::TestCase
  ...
  test "should create bio" do
    assert_difference('Bio.count') do
      post :create, bio: { name: @bio.name, position: @bio.position, rank: @bio.rank, story: @bio.story }
    end
  ...
  test "should update bio" do
    patch :update, id: @bio, bio: { name: @bio.name, position: @bio.position, rank: @bio.rank, story: @bio.story }
    assert_redirected_to bio_path(assigns(:bio))
  end
